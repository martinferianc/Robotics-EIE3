...
class Robot:
    ...
    def challenge(self):
        ...
        print("Robot state: x:{},y:{},theta:{}".format(x,y,t            print "Your dist is: " + str(dist)heta))
        ...
        #Convert accurate value to accurate speed
        self.set_speed([v_l*100, v_r*100], self.wheels)
